...
export default function LoginPage() {
  ...
  return (
    <PageWrapper className="min-h-screen grid-bg flex items-center justify-center px-4">
      {/* Background glow */}
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Sign in to manage your tournaments</p>
        </div>
        ...
        <div className="glass rounded-3xl p-8 border border-white/8">
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link to="/signup" className="text-cyan-neon hover:underline font-medium">Sign up free</Link>
          </div>

          <div className="mt-4 p-3 rounded-xl bg-white/3 border border-white/5">
            <p className="text-xs text-gray-600 text-center">💡 Demo: any email + password works</p>
          </div>
        </div>
      </motion.div>
    </PageWrapper>
